...
# python attm_run_ssda.py -cp "(0, 30)" -d "0" -t "single" -a True 
# python attm_run_ssda.py -cp "(0, 30)" -d "0" -t "single" -a False 
# python attm_run_ssda.py -cp "(0, 30)" -d "0" -t "multi" -a True 